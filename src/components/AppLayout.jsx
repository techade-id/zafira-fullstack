...
export default function AppLayout() {
  ...
  return (
    <div style={{ minHeight: "100vh", width: "100%", display: "flex", fontFamily: "'Segoe UI', Arial, sans-serif", background: "#fffaf5", color: TEXT_DARK }}>
      <div style={{ width: 240, background: "#2c1a0e", color: "#f5e6d8", flexShrink: 0, display: "flex", flexDirection: "column", padding: "18px 0", overflowY: "auto" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "0 20px 20px", fontWeight: 700, fontSize: 16, borderBottom: "1px solid rgba(255,255,255,0.08)", marginBottom: 10 }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        <div style={{ background: "#fff", borderBottom: `1px solid ${BORDER}`, padding: "14px 28px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: ORANGE_LIGHT, borderRadius: 8, padding: "8px 14px", fontSize: 13, color: TEXT_MID, width: 240 }}>
            <Search size={14} />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <button
              onClick={signOut}
              style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: ORANGE_DARK, background: ORANGE_LIGHT, border: `1px solid ${ORANGE_PALE}`, padding: "6px 12px", borderRadius: 6, cursor: "pointer" }}
            >
              <LogOut size={13} />
              Keluar
            </button>
